CREATE OR REPLACE VIEW NAGV_PM_VENDA AS 
--- View Criada em 24/05/2022 para integração com empresa PriceMet

SELECT FV.DTAOPERACAO DATA, 
       FV.NROEMPRESA NRO_EMPRESA, FV.SEQPRODUTO VENDA_SKU, SUM(FV.QTDOPERACAO) VENDA_QTD, 
       SUM(FV.VVLROPERACAOBRUTO) VENDA_VLR_BRUTO, SUM(FV.VLROPERACAO) VENDA_VLR_LIQUIDO,
...
GROUP BY FV.DTAOPERACAO, FV.SEQPRODUTO, FV.NROEMPRESA, FV.VLRPROMOC,FV.NROSEGMENTO;
